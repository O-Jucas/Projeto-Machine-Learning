...
def main():
    ...
    image_array = load_images(df_filtrado['image_path'].values, base_path=caminho_pasta_imagens, target_size=(64, 64))

    # Cria as colunas target numéricas com base no target string
    encode_labels(df_filtrado['word'].values, words_to_keep)
