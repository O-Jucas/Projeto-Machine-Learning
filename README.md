...
| **Diogo Lima** ([@brunora16](https://github.com/brunora16)) | Benchmarks e parte teórica |
| **Renan Guedes** ([@RenanMguedes] (https://github.com/RenanMguedes))| Estudo do comportamento das dimensões da imagem (PCA) |
| **Bruno Rodrigues** ([@dbclima] (https://github.com/dbclima)) | Estudo de viés cultural (desenho × país) |
