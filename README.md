...
R.E.P.O. criado para o projeto da disciplina Machine Learning

Modelo -> Performance ruim provavelmente pelo baixo numero de dados

Peguntas:
- Nosso modelo é pre-treinado? (Gabi)
...
- Vieses sobre desenho-país (Brunão)
  - Comparação do desempenho em desenhos de diferentes paises
